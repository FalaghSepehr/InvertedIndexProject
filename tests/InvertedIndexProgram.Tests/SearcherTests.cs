...
public class SearcherTests
{
  ...
  private static readonly Searcher _sut = new();
  ...
  public class Search
  {
    ...
    public void ReturnsResults_when_all_categories_active()
    {
      ...
      var result = _sut.Search(query, _invertedIndexDic);
  ...
  public class IntersectTermDocs
  {
    ...
    public void ReturnsEmptyDocsList_if_terms_empty()
    {
      ...
      var result = _sut.IntersectTermDocs(mustHaveTerms, _invertedIndexDic);
      Assert.Equal([], result);
    }
  ...
  public class UnionTermDocs
  {
    ...
    public void ReturnsEmptyDocsList_if_terms_empty()
    {
      ...
      var result = _sut.UnionTermDocs(terms, _invertedIndexDic);
      Assert.Equal([], result);
    }
  ...
  public class BuildResult
  {
    ...
    {
      var context = new SearchContext(true, true, true, ["doc1", "doc2"], ["doc2", "doc3"], ["doc3"]);
      var result = _sut.BuildResult(context, _invertedIndexDic);
      Assert.Equal(["doc2"], result);
    }
    ...
    {
      var context = new SearchContext(true, false, false, ["doc1", "doc2"], [], []);
      var result = _sut.BuildResult(context, _invertedIndexDic);
      Assert.Equal(["doc1", "doc2"], result);
    }
    ...
    {
      var context = new SearchContext(false, true, false, [], ["doc1", "doc2"], []);
      var result = _sut.BuildResult(context, _invertedIndexDic);
      Assert.Equal(["doc1", "doc2"], result);
    }
    ...
    {
      var context = new SearchContext(false, false, true, [], [], ["doc1"]);
      var result = _sut.BuildResult(context, _invertedIndexDic);
    ...
    {
      var context = new SearchContext(true, true, false, ["doc1", "doc2"], ["doc2", "doc3"], []);
      var result = _sut.BuildResult(context, _invertedIndexDic);
      Assert.Equal(["doc2"], result);
    }
    ...
    {
      var context = new SearchContext(true, false, true, ["doc1", "doc2"], [], ["doc2"]);
      var result = _sut.BuildResult(context, _invertedIndexDic);
    ...
    {
      var context = new SearchContext(true, true, false, ["doc1", "doc2"], [], []);
      var result = _sut.BuildResult(context, _invertedIndexDic);
      Assert.Equal([], result);
    }
    ...
    {
      var context = new SearchContext(true, false, false, [], [], []);
      var result = _sut.BuildResult(context, _invertedIndexDic);
      Assert.Equal([], result);
    }
    ...
    {
      var context = new SearchContext(false, false, false, [], [], []);
      var result = _sut.BuildResult(context, _invertedIndexDic);
      Assert.Equal([], result);
    }
    ...
    public void ReturnsIntersection_when_exclusion_terms_not_found()
    {
      ...
      var context = new SearchContext(true, true, true, ["doc1", "doc2"], ["doc2", "doc3"], []);
      var result = _sut.BuildResult(context, _invertedIndexDic);
      Assert.Equal(["doc2"], result);
    }
    ...
    {
      var context = new SearchContext(false, false, true, [], [], []);
      var result = _sut.BuildResult(context, _invertedIndexDic);
      Assert.Equal(["doc1", "doc2", "doc3"], result);
    }
  }
